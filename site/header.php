<!doctype HTML>
	<html lang="en">
		...
		<head>
			...
			<link rel="icon" type="image/x-icon" href="https://www.peprojects.dev/alpha-5/chanelle/images/logo-v1.png">
	...
	<body>
		<header class='site-header'>
			<inner-column>
				<divider>
					<home class='header-name'><a href="https://www.peprojects.dev/alpha-5/chanelle">
						Chanelle Craig
					</a></home>
